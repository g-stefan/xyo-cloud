...
class xyo_datasource_mysql_Table extends xyo_Config {
	...
	function &copyThis() {
		...
		$retV = new xyo_datasource_mysql_Table($this->module_, $this->connection_, $this->name_, $this->datasource_, $this->descriptor_, false);
		if ($retV) {
	...
	function createStorage() {
		...
		if ($this->primaryKey_) {
			...
			$query.="PRIMARY KEY(`" . $this->primaryKey_ . "`)";
		};
