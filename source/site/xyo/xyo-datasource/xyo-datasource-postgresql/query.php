...
class xyo_datasource_postgresql_Query extends xyo_Config {
	...
	function &copyThis() {
		$retV = new xyo_datasource_postgresql_Query($this->module_, $this->connection_, $this->name_, $this->datasource_, $this->descriptor_, false);
		if ($retV) {
	...
	function atomicAdd($field,$value) {
		return $this->fieldTable_[$this->primaryTable_]->atomicAdd($field,$value);
	}
	...
	function atomicSub($field,$value) {
		return $this->fieldTable_[$this->primaryTable_]->atomicSub($field,$value);
	}
