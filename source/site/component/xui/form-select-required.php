...
<br>
<select class="xui form-select<?php if($this->isElementError($element)){echo " -danger";}; ?> -required" name="<?php $this->eElementName($element); ?>" id="<?php $this->eElementId($element); ?>" <?php echo $submit; ?> >
<?php
