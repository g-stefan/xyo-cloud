...
$this->ecssBegin();
echo ".-com-inline.-loader{position:relative;width:100%;min-height:240px;}";
echo ".-com-inline.-div-1{height:240px;}";
echo ".-com-inline.-div-2{display:none;height:100%;width:100%;overflow:auto;}";
$this->ecssEnd();
...
if(!$noHtml) {
	echo "<div id=\"".$id."\" class=\"xui -overlay-scrollbars -com-inline -div-2\">";
